...
export function useTodos() {
  ...
  function addTodo(newTodo) {
     ...
     */
    createTodo(newTodo)
      .then((createdTodo) => setTodos((prevTodo) => [createdTodo, ...prevTodo]))
  ...
  function toggleCompleted(todoId) {
    ...
    const updateDbTodo = updatedTodos.find((todo) => todo.todoId === todoId);
    updateTodo(updateDbTodo).catch((error) => setError(error));
  }
